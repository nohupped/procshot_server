    ...
    pub fn new() -> Self {
        ...
        let matches = App::new("procshot")
                        ...
                        .arg(Arg::with_name("server")
                            ...
                            .long("server")
                            .default_value("false")
                            .help("Run as server. Server will run continuously and record stats while client mode read the recorded stats."))
                        .subcommand(SubCommand::with_name("server")
                            .about("Runs as server and records stats. Default path where it stores data is /var/log/procshot/data."))
